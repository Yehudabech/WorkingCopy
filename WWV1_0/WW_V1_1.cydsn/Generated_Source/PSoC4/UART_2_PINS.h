...
/* Unconfigured pins */
#define UART_2_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define UART_2_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define UART_2_REMOVE_TX_SCL_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define UART_2_RX_WAKE_SDA_MOSI_PIN (0u == UART_2_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define UART_2_RX_SDA_MOSI_PIN     (0u == UART_2_REMOVE_RX_SDA_MOSI_PIN)
#define UART_2_TX_SCL_MISO_PIN     (0u == UART_2_REMOVE_TX_SCL_MISO_PIN)
...
#if (UART_2_RX_WAKE_SDA_MOSI_PIN)
    #include "UART_2_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (UART_2_RX_SDA_MOSI) */

#if (UART_2_RX_SDA_MOSI_PIN)
    #include "UART_2_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (UART_2_RX_SDA_MOSI) */

#if (UART_2_TX_SCL_MISO_PIN)
    #include "UART_2_uart_tx_i2c_scl_spi_miso.h"
#endif /* (UART_2_TX_SCL_MISO) */
...
#if (UART_2_RX_SDA_MOSI_PIN)
    #define UART_2_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_2_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define UART_2_RX_SDA_MOSI_HSIOM_MASK      (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_2_RX_SDA_MOSI_HSIOM_POS       (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define UART_2_RX_SDA_MOSI_HSIOM_SEL_GPIO  (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define UART_2_RX_SDA_MOSI_HSIOM_SEL_I2C   (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define UART_2_RX_SDA_MOSI_HSIOM_SEL_SPI   (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define UART_2_RX_SDA_MOSI_HSIOM_SEL_UART  (UART_2_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (UART_2_RX_WAKE_SDA_MOSI_PIN)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_MASK      (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_POS       (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define UART_2_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define UART_2_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_2_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) UART_2_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define UART_2_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (UART_2_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define UART_2_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) UART_2_INTCFG_TYPE_MASK << \
                                                                           UART_2_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins UART_2_RX_SDA_MOSI_PIN or UART_2_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (UART_2_RX_SDA_MOSI_PIN) */

#if (UART_2_TX_SCL_MISO_PIN)
    #define UART_2_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define UART_2_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define UART_2_TX_SCL_MISO_HSIOM_MASK      (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define UART_2_TX_SCL_MISO_HSIOM_POS       (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define UART_2_TX_SCL_MISO_HSIOM_SEL_GPIO  (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define UART_2_TX_SCL_MISO_HSIOM_SEL_I2C   (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define UART_2_TX_SCL_MISO_HSIOM_SEL_SPI   (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define UART_2_TX_SCL_MISO_HSIOM_SEL_UART  (UART_2_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (UART_2_TX_SCL_MISO_PIN) */
...
/* Pins settings index. */
#define UART_2_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define UART_2_RX_SDA_MOSI_PIN_INDEX       (0u)
#define UART_2_TX_SCL_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define UART_2_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << UART_2_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define UART_2_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << UART_2_RX_SDA_MOSI_PIN_INDEX)
#define UART_2_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << UART_2_TX_SCL_MISO_PIN_INDEX)
...
#if (UART_2_TX_SCL_MISO_PIN)
    #define UART_2_CHECK_TX_SCL_MISO_PIN_USED \
                (UART_2_PIN_DM_ALG_HIZ != \
                    UART_2_GET_P4_PIN_DM(UART_2_uart_tx_i2c_scl_spi_miso_PC, \
                                                   UART_2_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (UART_2_TX_SCL_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define UART_2_SET_I2C_SCL_DR(val) \
                            UART_2_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define UART_2_SET_I2C_SCL_HSIOM_SEL(sel) \
                    UART_2_SET_HSIOM_SEL(UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   UART_2_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   UART_2_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define UART_2_WAIT_SCL_SET_HIGH  (0u == UART_2_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (UART_2_RX_SDA_MOSI_PIN)
    #define UART_2_SET_I2C_SCL_DR(val) \
                            UART_2_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define UART_2_SET_I2C_SCL_HSIOM_SEL(sel) \
                            UART_2_SET_HSIOM_SEL(UART_2_RX_SDA_MOSI_HSIOM_REG,  \
                                                           UART_2_RX_SDA_MOSI_HSIOM_MASK, \
                                                           UART_2_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define UART_2_WAIT_SCL_SET_HIGH  (0u == UART_2_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (UART_2_TX_SCL_MISO_PIN)
    #define UART_2_WAIT_SDA_SET_HIGH  (0u == UART_2_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define UART_2_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) UART_2_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define UART_2_REMOVE_MOSI_SCL_RX_WAKE_PIN    UART_2_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define UART_2_REMOVE_MOSI_SCL_RX_PIN         UART_2_REMOVE_RX_SDA_MOSI_PIN
#define UART_2_REMOVE_MISO_SDA_TX_PIN         UART_2_REMOVE_TX_SCL_MISO_PIN
...
/* Unconfigured pins */
#define UART_2_MOSI_SCL_RX_WAKE_PIN   UART_2_RX_WAKE_SDA_MOSI_PIN
#define UART_2_MOSI_SCL_RX_PIN        UART_2_RX_SDA_MOSI_PIN
#define UART_2_MISO_SDA_TX_PIN        UART_2_TX_SCL_MISO_PIN
...
#define UART_2_SS0_PIN                UART_2_RTS_SS0_PIN
    ...
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_REG     UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_PTR     UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_MASK    UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_POS     UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_REG    UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_PTR    UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  UART_2_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (UART_2_RX_WAKE_SDA_MOSI_PIN) */

#if (UART_2_MOSI_SCL_RX_PIN)
    #define UART_2_MOSI_SCL_RX_HSIOM_REG      UART_2_RX_SDA_MOSI_HSIOM_REG
    #define UART_2_MOSI_SCL_RX_HSIOM_PTR      UART_2_RX_SDA_MOSI_HSIOM_PTR
    #define UART_2_MOSI_SCL_RX_HSIOM_MASK     UART_2_RX_SDA_MOSI_HSIOM_MASK
    #define UART_2_MOSI_SCL_RX_HSIOM_POS      UART_2_RX_SDA_MOSI_HSIOM_POS
#endif /* (UART_2_MOSI_SCL_RX_PIN) */

#if (UART_2_MISO_SDA_TX_PIN)
    #define UART_2_MISO_SDA_TX_HSIOM_REG      UART_2_TX_SCL_MISO_HSIOM_REG
    #define UART_2_MISO_SDA_TX_HSIOM_PTR      UART_2_TX_SCL_MISO_HSIOM_REG
    #define UART_2_MISO_SDA_TX_HSIOM_MASK     UART_2_TX_SCL_MISO_HSIOM_REG
    #define UART_2_MISO_SDA_TX_HSIOM_POS      UART_2_TX_SCL_MISO_HSIOM_REG
...
#define UART_2_MOSI_SCL_RX_WAKE_PIN_INDEX UART_2_RX_WAKE_SDA_MOSI_PIN_INDEX
#define UART_2_MOSI_SCL_RX_PIN_INDEX      UART_2_RX_SDA_MOSI_PIN_INDEX
#define UART_2_MISO_SDA_TX_PIN_INDEX      UART_2_TX_SCL_MISO_PIN_INDEX
...
#define UART_2_MOSI_SCL_RX_WAKE_PIN_MASK UART_2_RX_WAKE_SDA_MOSI_PIN_MASK
#define UART_2_MOSI_SCL_RX_PIN_MASK      UART_2_RX_SDA_MOSI_PIN_MASK
#define UART_2_MISO_SDA_TX_PIN_MASK      UART_2_TX_SCL_MISO_PIN_MASK
