...
void UART_2_UartPostEnable(void)
{
        ...
        if (UART_2_CHECK_TX_SCL_MISO_PIN_USED)
        {
            /* Set SCB UART to drive the output pin */
            UART_2_SET_HSIOM_SEL(UART_2_TX_SCL_MISO_HSIOM_REG, UART_2_TX_SCL_MISO_HSIOM_MASK,
                                           UART_2_TX_SCL_MISO_HSIOM_POS, UART_2_TX_SCL_MISO_HSIOM_SEL_UART);
        }
    #endif /* (UART_2_TX_SCL_MISO_PIN_PIN) */
...
void UART_2_UartStop(void)
{
        ...
        if (UART_2_CHECK_TX_SCL_MISO_PIN_USED)
        {
            ...
            UART_2_SET_HSIOM_SEL(UART_2_TX_SCL_MISO_HSIOM_REG, UART_2_TX_SCL_MISO_HSIOM_MASK,
                                           UART_2_TX_SCL_MISO_HSIOM_POS, UART_2_TX_SCL_MISO_HSIOM_SEL_GPIO);
        }
    #endif /* (UART_2_TX_SCL_MISO_PIN_PIN) */
