// ======================================================================
// WW_V1_1.v generated from TopDesign.cysch
// 08/10/2018 at 18:07
...
module BLE_v3_52_0 (
	...
	cy_clock_v1_0
		#(.id("19c53405-87de-4725-b4b2-3404ce58cad8/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("50eb934e-38d0-45b5-be60-c3d3a353acca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__VerUp_net;
	wire [0:0] tmpFB_0__VerUp_net;
	wire [0:0] tmpIO_0__VerUp_net;
	wire [0:0] tmpINTERRUPT_0__VerUp_net;
	electrical [0:0] tmpSIOVREF__VerUp_net;

	cy_psoc3_pins_v1_10
		#(.id("fca04f4e-1ab2-48af-8099-71a2c0c760dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VerUp
		 (.oe(tmpOE__VerUp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VerUp_net[0:0]}),
		  .io({tmpIO_0__VerUp_net[0:0]}),
		  .siovref(tmpSIOVREF__VerUp_net),
		  .interrupt({tmpINTERRUPT_0__VerUp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VerUp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VerDown_net;
	wire [0:0] tmpFB_0__VerDown_net;
	wire [0:0] tmpIO_0__VerDown_net;
	wire [0:0] tmpINTERRUPT_0__VerDown_net;
	electrical [0:0] tmpSIOVREF__VerDown_net;

	cy_psoc3_pins_v1_10
		#(.id("bbb076ec-6fdf-41ec-bd1a-0fca96833bce"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VerDown
		 (.oe(tmpOE__VerDown_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VerDown_net[0:0]}),
		  .io({tmpIO_0__VerDown_net[0:0]}),
		  .siovref(tmpSIOVREF__VerDown_net),
		  .interrupt({tmpINTERRUPT_0__VerDown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VerDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HozIn_net;
	wire [0:0] tmpFB_0__HozIn_net;
	wire [0:0] tmpIO_0__HozIn_net;
	wire [0:0] tmpINTERRUPT_0__HozIn_net;
	electrical [0:0] tmpSIOVREF__HozIn_net;

	cy_psoc3_pins_v1_10
		#(.id("6c77d8be-2aba-4694-99e0-f7c2672ff4be"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		HozIn
		 (.oe(tmpOE__HozIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HozIn_net[0:0]}),
		  .io({tmpIO_0__HozIn_net[0:0]}),
		  .siovref(tmpSIOVREF__HozIn_net),
		  .interrupt({tmpINTERRUPT_0__HozIn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HozIn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HorOut_net;
	wire [0:0] tmpFB_0__HorOut_net;
	wire [0:0] tmpIO_0__HorOut_net;
	wire [0:0] tmpINTERRUPT_0__HorOut_net;
	electrical [0:0] tmpSIOVREF__HorOut_net;

	cy_psoc3_pins_v1_10
		#(.id("dbd6345e-e2a8-4a28-adbb-bbb509844f3b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HorOut
		 (.oe(tmpOE__HorOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HorOut_net[0:0]}),
		  .io({tmpIO_0__HorOut_net[0:0]}),
		  .siovref(tmpSIOVREF__HorOut_net),
		  .interrupt({tmpINTERRUPT_0__HorOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HorOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PBUp_net;
	wire [0:0] tmpFB_0__PBUp_net;
	wire [0:0] tmpIO_0__PBUp_net;
	wire [0:0] tmpINTERRUPT_0__PBUp_net;
	electrical [0:0] tmpSIOVREF__PBUp_net;
	...
	cy_psoc3_pins_v1_10
		...
		PBUp
		 (.oe(tmpOE__PBUp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PBUp_net[0:0]}),
		  .io({tmpIO_0__PBUp_net[0:0]}),
		  .siovref(tmpSIOVREF__PBUp_net),
		  .interrupt({tmpINTERRUPT_0__PBUp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PBUp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PBDown_net;
	wire [0:0] tmpFB_0__PBDown_net;
	wire [0:0] tmpIO_0__PBDown_net;
	wire [0:0] tmpINTERRUPT_0__PBDown_net;
	electrical [0:0] tmpSIOVREF__PBDown_net;

	cy_psoc3_pins_v1_10
		#(.id("1707f947-9d8a-4e28-a130-9863e2c09c5c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PBDown
		 (.oe(tmpOE__PBDown_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PBDown_net[0:0]}),
		  .io({tmpIO_0__PBDown_net[0:0]}),
		  .siovref(tmpSIOVREF__PBDown_net),
		  .interrupt({tmpINTERRUPT_0__PBDown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PBDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PBIn_net;
	wire [0:0] tmpFB_0__PBIn_net;
	wire [0:0] tmpIO_0__PBIn_net;
	wire [0:0] tmpINTERRUPT_0__PBIn_net;
	electrical [0:0] tmpSIOVREF__PBIn_net;

	cy_psoc3_pins_v1_10
		#(.id("9f7ddefb-a31b-4971-8df6-36b39c7fe680"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PBIn
		 (.oe(tmpOE__PBIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PBIn_net[0:0]}),
		  .io({tmpIO_0__PBIn_net[0:0]}),
		  .siovref(tmpSIOVREF__PBIn_net),
		  .interrupt({tmpINTERRUPT_0__PBIn_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PBIn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PBOut_net;
	wire [0:0] tmpFB_0__PBOut_net;
	wire [0:0] tmpIO_0__PBOut_net;
	wire [0:0] tmpINTERRUPT_0__PBOut_net;
	electrical [0:0] tmpSIOVREF__PBOut_net;

	cy_psoc3_pins_v1_10
		#(.id("66656de2-4f0c-4b89-bb09-81949a86c215"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		PBOut
		 (.oe(tmpOE__PBOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PBOut_net[0:0]}),
		  .io({tmpIO_0__PBOut_net[0:0]}),
		  .siovref(tmpSIOVREF__PBOut_net),
		  .interrupt({tmpINTERRUPT_0__PBOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PBOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ec601893-0e9c-4088-973f-25090c8e6dc1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
